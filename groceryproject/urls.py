...
urlpatterns = [
    ...
    path('driver-order/', staff_order, name="driver_order"), 
    path('staff-order-track/<int:pid>/', staff_order_track, name="staff_order_track"),
    path('invoice_bill/<int:pid>', InvoiceView, name="invoice"),
